...
(* 
   ...
   Correspondence:
     Java        OCaml
      ...
      In OCaml, module is not Object-Oriented Programming, but rather a group of relevant defs and 
      functions. A module name is just a port to that group of stuff. It's easier to understand if 
      we write type 'a stack instead of type 'a t
